...
function initPayment() {
  ...
  if (request.receiveMethod === 'binance') {
    ...
    receiveMethodLabel.innerText = 'আপনার Bybit UID अथवा USDT Wallet Address';
    ...
    receiveMethodLabel.innerText = 'আপনার Account ID अथवा Wallet Address';
  ...
  paymentForm.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
      if (request.sendMethod === 'bkash') {
        ...
        const transaction = createTransaction({ ...updatedRequest, txid: 'N/A' });
